...
poliedri. Un esemprio è la rappresentazione con soli vincoli o la /Doppia
Rappresentazione/ (descritta nella sezione successiva).

In questa tesi verrà discusso il lavoro svolto per l'implementazione,
all'interno della libreria /PPLite/, dei poliedri fattorizzati. Le operazioni
...
inizialmente, crea un blocco ~lub~ che sarà composto dalle variabili non in
comune tra ~b1~ e ~b2~:

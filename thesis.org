...
+ tramite un sistema finito di vincoli $\mathcal{C}$. I vincoli
  ...
  gli iperpiani e i semispazi del poliedro \cite{becchi};
...
~std::insert~. E importante notare che questa operazione sia
...
*** ~intersection_assign~
Questa funzione non fa altro che richiamare ~add_con~ ??
*** ~widen~
** Altre operazioni

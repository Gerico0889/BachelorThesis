...
\label{sec:org3339474}

\chapter{Fattorizzazione cartesiana}
\label{sec:org68c310b}
...
\begin{itemize}
\item \texttt{Block}: un \texttt{std::vector} di \texttt{dim\_type} che rappresenta un blocco \(\mathcal{X}_i\) che
...
\label{sec:org4d55763}


\chapter{Conclusione}
\label{sec:org9fa8920}
\end{document}

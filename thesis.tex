...
\label{sec:orgc833658}

\chapter{Fattorizzazione cartesiana}
\label{sec:orgd34fac9}
...
Q). Una volta fatto ciò non si fa altro che scrorrere i vari fattori e
...
\end{lstlisting}
\item a questo punto è necessario aggiuntere a \texttt{O} e \texttt{U} i poliedri che sono
...
\end{itemize}
\subsection{\texttt{intersection\_assign}}
\label{sec:org0c7e9aa}
Questa funzione non fa altro che richiamare \texttt{add\_con} ??
\subsection{\texttt{widen}}
\label{sec:orgbe101da}
\section{Altre operazioni}
\label{sec:orgd28c6b5}
